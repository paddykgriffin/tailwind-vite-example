...
export default function Contact() {
  ...
  return (
    <Section className="bg-gray-100 text-center dark:bg-[#121212]" id="contact">
      <Typography
        variant="h2"
        className="inline-block border-b-2 border-b-[#DFDFDF] pb-4 tracking-wide text-[#333333] uppercase dark:text-white"
      >
        Contact US
      </Typography>

      <div className="grid gap-6 md:grid-cols-2 md:pt-16">
